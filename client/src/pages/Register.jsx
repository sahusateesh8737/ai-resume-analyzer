...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#050505] bg-noise relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-yellow-500/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-yellow-600/5 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md p-8 sm:p-10 liquid-glass-card rounded-3xl relative z-10 m-4 shadow-2xl border border-white/10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Join SyncATS to optimize your career</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <Link to="/login" className="text-yellow-500 hover:text-yellow-400 font-bold hover:underline transition-colors">
              Log in here
            </Link>
          </p>
        </div>
